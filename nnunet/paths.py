...
#base = os.environ['DATASET'] if "DATASET" in os.environ.keys() else None
...
base = r'C:/Users/zj_la/Desktop/nnunet_win_test/nnunet/DATASET/nnUNet_raw_data_base'
preprocessing_output_dir = r'C:/Users/zj_la/Desktop/nnunet/DATASET/nnUNet_preprocessed'
network_training_output_dir_base = r'C:/Users/zj_la/Desktop/nnunet/DATASET/nnUNet_trained_models'

if base is not None:
    nnUNet_raw_data = os.path.join(base, "nnUNet_raw_data_base")
    ...
    print("DATASET is not defined and nnU-Net can only be used on data for which preprocessed files "
