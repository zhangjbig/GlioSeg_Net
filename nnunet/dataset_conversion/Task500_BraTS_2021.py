...
def copy_BraTS_segmentation_and_convert_labels(in_file, out_file):
    # use this for segmentation only!!!仅用于分割！！！
    # nnUNet wants the labels to be continuous. BraTS is 0, 1, 2, 4 -> we make that into 0, 1, 2, 3
    # nnUNet希望标签是连续的。BraTS是0，1，2，4->我们将其分为0，1、2、3
...
if __name__ == "__main__":
    ...
    这段代码一团糟。它是按原样提供的，没有任何保证。你必须自己去挖掘。祝你好运；-）
    记住在预测后将标签转换回BRATS约定！
    """

    task_name = "Task600_BraTS2021"
    downloaded_data_dir = "E:/nnUNet_win/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/BraTS2021_Data/BraTS2021_TrainingData"
    downloaded_data_dir_val = "E:/nnUNet_win/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/BraTS2021_ValidationData"
    result_dir = "E:/nnUNet_win/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task600_BraTS2021/"
    ...
    #downloaded_data_dir_test = "/home/xzy/machinedisk/nnUNet/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data_base/BraTS2021_TestingData"
